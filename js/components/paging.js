...
class Paging {
    constructor() {
        ...
        // Load paging's data from API
    initEvents() {
        // Display paging list when press dropdown button
        $('#paging-dropdown').on('click', this.pagingDisplay);
        // Display value on input when choose item in paging list
        $('.paging-list').on('click', '.d-combobox-item', this.departValueDisplay);
        // press key down and key up to choose paging
    ...
    inputComboboxOnKeyDown() {
        // Get all element of paging list:
        ...
        switch (event.keyCode) {
            case 13: // Enter key:
                ...
                if (itemHoverred.length == 1) {
                    ...
                    // Assign value to paging-contain
    ...
    pagingDisplay() {
        ...
        // let itemParent = $(dropdownGrandpa).children('paging-list');
        ...
        $('.content--paging .paging-list').toggle();
    }
    ...
    departValueDisplay() {
        ...
        //Assign value for combobox paging
        let grandpaItemElement = $('this').parents('paging--contain');
